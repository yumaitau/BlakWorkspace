...
const shellApps = [{ id:'portal', name:'Workspace', url:'https://portal.homelab.local/', backend:'Blak Workspace by Yuma IT' }, ...APPS.filter(a=>a.status==='live' && a.url && a.id!=='idp').map(a=>({id:a.id,name:a.name,url:new URL(a.url,'https://portal.homelab.local').href,backend:a.backend}))];
