...
REDIRECTS = [RedirectURI(matching_mode=RedirectURIMatchingMode.STRICT, url="http://hermes.workspace.example.com/oauth/oidc/callback")]
...
provider, created = reconcile_provider(slug='hermes', name="Hermes", defaults={"authorization_flow": auth_flow, "invalidation_flow": inval_flow, "client_type": "confidential", "client_id": "openwebui", "redirect_uris": REDIRECTS, "signing_key": key, "sub_mode": "user_username", "include_claims_in_id_token": True, "issuer_mode": "per_provider"})
if created:
