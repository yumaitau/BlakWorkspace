...
const APPS = [
  ...
  { id: 'sites', name: 'Blak Knowledge', desc: 'Team knowledge', url: 'https://sites.workspace.example.com', backend: 'Powered by Outline', group: 'Organise', status: 'live', oidcClient: 'outline', check: { proto: 'http', host: 'sites', port: 3000, path: '/_health' } },
  ...
  { id: 'idp', name: 'Blak Admin', desc: 'Workspace administration', url: 'https://id.workspace.example.com', backend: 'Powered by Authentik', group: 'Platform', status: 'live', oidcClient: 'authentik', check: { proto: 'http', host: 'authentik-server', port: 9000, path: '/-/health/ready/' } },
